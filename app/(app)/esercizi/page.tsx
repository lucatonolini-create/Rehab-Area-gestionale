...
export default function EserciziPage() {
  ...
  return (
    <div className="h-full overflow-y-auto overscroll-none px-4 md:px-6 page-scroll" style={{ paddingTop: "1.5rem" }}>
      <div className="mb-4">
      ...
      {/* Modale */}
      {mostraForm && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-end md:items-center justify-center md:p-4 px-3" style={{ paddingTop: "16px", paddingBottom: "calc(env(safe-area-inset-bottom, 34px) + 110px)" } as React.CSSProperties}>
          <div ref={formModalRef as React.RefObject<HTMLDivElement>} className="bg-white rounded-2xl w-full max-w-2xl md:max-h-[90vh] flex flex-col shadow-2xl overflow-hidden" style={{ maxHeight: "calc(100dvh - 16px - env(safe-area-inset-bottom, 34px) - 110px)" }}>
            ...
            <div className="px-4 pt-4 overflow-y-auto flex-1 space-y-4" style={{ }}>
              ...
              {!editId && form.atletaId && (() => {
                const candidati = atletiOrdinati.filter((a) => a.id !== form.atletaId && a.stato === "Infortunato");

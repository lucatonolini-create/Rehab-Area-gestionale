...
export default function SegnalazioniPage() {
  ...
  return (
    <div className="h-full overflow-y-auto overscroll-none px-6 max-w-xl mx-auto" style={{ paddingTop: "calc(env(safe-area-inset-top, 0px) + 1.5rem)", paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 4px)" }}>
